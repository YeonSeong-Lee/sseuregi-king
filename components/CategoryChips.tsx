...
const COLORS: Record<WasteCategory, string> = {
  ...
  e_waste:      'border-indigo-300 text-indigo-800 data-[active=true]:bg-indigo-100 dark:border-indigo-500/40 dark:text-indigo-300 dark:data-[active=true]:bg-indigo-500/20',
